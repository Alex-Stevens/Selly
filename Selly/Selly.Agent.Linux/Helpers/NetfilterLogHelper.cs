...
namespace Selly.Agent.Linux.Helpers
{
    public class NetfilterLogHelper
    {
        ...
        public NetfilterLogHelper()
        {
            ...
            proc.StartInfo.FileName = "/home/user/selly/Selly/Selly.Agent.Linux.NetfilterLog/main";
        ...
        private void OutputDataReceivedOccured(object sender, DataReceivedEventArgs e)
        {
            try
            {
                ...
                SellyService.ApiClient.SendEvent(new NMS.API.DTO.PacketDroppedEvent()
                {
            ...
            {
                ExceptionHelper.WriteFile(ex, "NetFilter");
